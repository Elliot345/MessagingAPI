...
public class DisplayManager {
  ...
  public void render() throws java.io.IOException, java.lang.InterruptedException {
    // emptying display
  ...
  */
  ...
  public void displayWindowSize() throws IOException, InterruptedException {
    // drawing window dimentions
    clear();

    drawRect(0, 0, width, height);
    drawCenteredText("These are the window dimentions; resize terminal accordingly", Math.round(width / 2), Math.round(height / 2));
